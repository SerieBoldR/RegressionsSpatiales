...
## Vecteurs propres de Moran {#sec-071}
...
#| message: false
#| warning: false
#| fig-cap: Autocorrélation des vecteurs propres issus d'une matrice de contiguïté (Queen) sur les secteurs de recensement de la région métropolitaine de recensement de Montréal
#| fig-align: center
#| out-width: 85%
