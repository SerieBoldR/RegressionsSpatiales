...
Nous notons une nette amélioration dans la distribution des résidus (@fig-ressev2). Nous effectuerons l'interprétation des résultats de ce modèle en comparaison avec ceux obtenus par les deux autres versions (@sec-0734).
