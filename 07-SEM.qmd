...
carte1 <- tm_shape(data_mtl) +
            tm_polygons(col=NULL,
              ...
              tm_title(size = 0.85,
                       text = paste0('Vecteur propre 10 (I de Moran = ',
...
carte2 <- tm_shape(data_mtl) +
            tm_polygons(col=NULL,
              ...
              tm_layout(frame=FALSE) +
              tm_title(size = 0.85,
                       text = paste0('Vecteur propre 100 (I de Moran = ',
...
carte3 <- tm_shape(data_mtl) +
            tm_polygons(col=NULL,
              ...
              tm_layout(frame=FALSE) +
              tm_title(size = 0.85,
                       text = paste0('Vecteur propre 375 (I de Moran = ',
...
carte4 <- tm_shape(data_mtl) +
            tm_polygons(col=NULL,
              ...
              tm_layout(frame=FALSE) +
              tm_title(size = 0.85,
                       text = paste0('Vecteur propre 970 (I de Moran = ',
