...
#| message: false
#| warning: false
# Résultats de matrice de pondérations spatiales avec un seuil de 1000 mètres
...
:::
::: bloc_aller_loin-body
**Les régressions géographiquement pondérées** ([chapitre @sec-chap08] et [chapitre @sec-chap09]), sont des outils d'exploration particulièrement adaptés pour explorer et cartographier l'instabilité des relations entre la variable dépendante et les variables indépendantes d'un modèle de régression.
