...
Deux motivations principales peuvent conduire à réaliser des régressions spatiales : la **dépendance spatiale** ou l'**hétérogénéité** du modèle de régression classique appliquées à des données spatiales [@chi2019spatial, p. 41-43].
...
::: bloc_exercice-icon
:::
**Exercice 2.** Matrice de contiguïté selon partage d'un segment et I de Moran
:::
::: bloc_exercice-body
```{r}
#| echo: true 
