...
#| fig-cap: Parts modales du transport en commun et de l'automobile (proportion)
#| fig-align: center
...
# les voisins les plus proches avec le seuil de distance maximale
...
-   selon des permutations Monte-Carlo (ci-dessous avec 999 permutations)
