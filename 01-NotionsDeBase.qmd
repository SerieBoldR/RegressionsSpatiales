...
Le code ci-dessous génère les matrices de pondération spatiale standardisées en ligne selon les ordres d'adjacence de 1 à 3.
...
# Création des matrices de pondération spatiale standardisées en ligne
...
**Les modèles linéaires généralisés et ceux avec filtrage spatial** ([chapitre @sec-chap07]) permettent de capturer les tendances spatiales en résumant la matrice de pondérations spatiales $W$.
:::
:::
