...
### Jeu de données sur la région métropolitaine de Montraéal {#sec-0114}


### Jeu de données sur la densité pour six villes espagnoles {#sec-0115}
...
### Jeu de données sur la densité pour six régions métropolitaines espagnoles {#sec-0116}
...
Deux motivations principales peuvent conduire à réaliser des régressions spatiales: la **dépendance spatiale** ou l'**hétérogénéité** du modèle de régression aspatiale [@chi2019spatial, pp. 41-43].
...
**Les modèles linéaires généralisés avec des vecteurs propres** ([chapitre @sec-chap06) à compléter plus tard.
...
::: bloc_aller_loin-icon
:::
**Hétérogénité ou non-stationnarité spatiale et méthodes de régression spatiale : quelles solutions?**
:::
::: bloc_aller_loin-body
