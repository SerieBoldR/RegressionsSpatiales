# Modèles généralisés additifs {#sec-chap06}
...
## *Markov random field* (MRF) ou spline bivariée? {#sec-064}
...
## Mise en œuvre et analyse dans R {#sec-065}
...
### GAM avec spline spatiale de type MRF {#sec-0653}
...
#| eval: true
#| warning: false
#| label: fig-gam2_k150_res
#| fig-cap: Résidus du modèle GAM avec une spline de type MRF avec k = 150
#| fig-align: center
#| out-width: 85%
...
#| tbl-cap: Résultats du modèle GLM avec une spline spatiale de type MRF
library(knitr)
library(kableExtra)
...
Correction à la [section @sec-11061].
:::
:::
...
Correction à la [section @sec-11062].
:::
:::
