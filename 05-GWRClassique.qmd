...
Outre les fonctions noyaux (*kernel*) gaussienne et bicarrée, il est aussi possible d'utiliser des fonctions exponentielle (@eq-kernelexponentielle), tricube (@eq-kerneltricube) et Boxcar (@eq-kernelboxcar) implémentées dans les fonctions `bw.gw` et `gwr.basic` du *package* `GWmodel`.
...
#| fig-align: center
#| fig-cap: "Fonctions noyaux (*kernel*) pour définir la matrice de pondération W(i)"
#| out-width: 75%
library(ggplot2)
library(ggpubr)
b <- 5000
...
#| fig-cap: "Cartographie des valeurs locales de R^2^ et de t"
#| fig-align: center
#| out-width: 100%
#| echo: false
#| message: false
...
#| fig-align: center
#| fig-cap: Cartographie des coefficients de régression locaux de la GWR
#| out-width: 100%
# Paramètres pour la légende 
legende_parametres <- list(text.separator = "à",
                           decimal.mark = ",",
...
#| label: fig-GWRValT
#| fig-align: center
#| fig-cap: "Cartographie des valeurs de *t* locales de la GWR"
#| out-width: 100%
