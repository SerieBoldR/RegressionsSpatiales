# Régressions géographiquement pondérées classiques {#sec-chap05}
...
## Principe de base {#sec-051}

### Pourquoi recourir à une régression géographiquement pondérée? {#sec-0511}
...
### Formulation de la GWR {#sec-0512}
...
### Exemple applicatif de la GWR {#sec-0513}
...
#### Résultats du modèle global {#sec-05131}
...
#### Résultats du modèle GWR {#sec-05132}
...
## Mise en œuvre et analyse dans R {#sec-052}
...
### GWR avec le *package* `spgwr` {#sec-0521}

#### Définition de la taille de la zone d'influence {#sec-05211}
...
#### Réalisation de la GWR {#sec-05212}
...
#### Comparaison des modèles MCO et GWR {#sec-05213}
...
#### Cartographie des résultats du modèle GWR {#sec-05214}
...
##### Cartographie et analyse des R^2^ locaux {#sec-052141}
...
##### Cartographie des coefficients de régression locaux {#sec-052142}
...
##### Cartographie des valeurs de *t* locales {#sec-052143}
...
##### Cartographie du nombre de variables significatives {#sec-052144}
...
##### Cartographie de la variable la plus significative avec la valeur de *t* {#sec-052145}
...
### GWR avec le *package* `GWmodel` {#sec-0522}
...
#### Définition de la taille de la zone d'influence {#sec-05221}
...
#### Réalisation de la GWR {#sec-05222}
...
## GWR classiques pour d'autres distributions {#sec-053}
...
## Limites et critiques des GWR {#sec-054}
...
à compléter
```
Correction à la [section @sec-10053].
:::
:::
