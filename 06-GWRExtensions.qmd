# Extensions de la régression géographiquement pondérée (en cours de rédaction) {#sec-chap06}

Dans le [chapitre @sec-chap05], nous avons présenté les trois formes classiques de la régression géographiquement pondérée (GWR) qui permettent de modéliser des variables dépendantes continues (GWR gaussienne), dichotomiques (GWR logistique) ou des variables de comptage (GWR Poisson). Depuis la publication de l'ouvrage de référence de Steward Fotheringham, Chris Brunsdon et Martin Charlton [-@fotheringham2003geographically], plusieurs extensions ont vu le jour. Parmi celles-ci, nous abordons dans ce chapitre :
...
## Régression géographiquement pondérée mixte {#sec-061}

### Principe de base de la GWR mixte {#sec-0611}

#### Pourquoi recourir à une GWR mixte {#sec-06111}

#### Formulation de la GWR mixte {#sec-06112}

### Mise en oeuvre de la GWR mixte dans R {#sec-0612}

## Régression géographiquement pondérée multiéchelle {#sec-062}

### Principe de base de la MGWR {#sec-0621}

#### Pourquoi recourir à une GWR mixte {#sec-06211}

#### Formulation de la GWR mixte {#sec-06212}

### Mise en oeuvre de la MGWR dans R {#sec-0622}

## Régression géographiquement pondérée mixte avec des variables spatialement décalée {#sec-063}

### Principe de base de la MGWR-SAR {#sec-0631}

#### Pourquoi recourir à une MGWR-SAR {#sec-06311}

#### Formulation de la MGWR-SAR {#sec-06312}

### Mise en oeuvre de la MGWR-SAR dans R {#sec-0632}

## Quiz de révision {#sec-064}
...
Correction à la [section @sec-10061].
:::
:::
...
Correction à la [section @sec-10062].
:::
:::
...
Correction à la [section @sec-10063].
:::
:::
