# Régressions géographiquement pondérées classiques {#sec-chap08}
...
## Principe de base {#sec-081}

### Pourquoi recourir à une régression géographiquement pondérée? {#sec-0811}
...
### Formulation de la GWR {#sec-0812}
...
### Exemple applicatif de la GWR {#sec-0813}
...
#### Résultats du modèle global {#sec-08131}
...
#### Résultats du modèle GWR {#sec-08132}
...
## Mise en œuvre et analyse dans R {#sec-082}
...
### GWR avec le *package* `spgwr` {#sec-0821}

#### Définition de la taille de la zone d'influence {#sec-08211}
...
#### Réalisation de la GWR {#sec-08212}
...
#### Comparaison des modèles MCO et GWR {#sec-08213}
...
#### Cartographie des résultats du modèle GWR {#sec-08214}
...
##### Cartographie et analyse des R^2^ locaux {#sec-082141}
...
##### Cartographie des coefficients de régression locaux {#sec-082142}
...
##### Cartographie des valeurs de *t* locales {#sec-082143}
...
##### Cartographie du nombre de variables significatives {#sec-082144}
...
##### Cartographie de la variable la plus significative avec la valeur de *t* {#sec-082145}
...
### GWR avec le *package* `GWmodel` {#sec-0822}
...
#### Définition de la taille de la zone d'influence {#sec-08221}
...
#### Réalisation de la GWR {#sec-08222}
...
## GWR classiques pour d'autres distributions {#sec-083}
...
## Limites et critiques des GWR {#sec-084}
...
modele_gwr
```
Correction à la [section @sec-11081].
:::
:::
...
à compléter
```
Correction à la [section @sec-11082].
:::
:::
...
à compléter
```
Correction à la [section @sec-11083].
:::
:::
